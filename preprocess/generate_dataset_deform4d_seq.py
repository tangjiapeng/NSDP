...
def generate_meshes(mesh_directory, dataset_directory, mesh_format, skip_existing=True, max_threads=-1, filter_lst=None, interval=3):
    ...
    output_dirs = Parallel(n_jobs=n_jobs)(
        delayed(process_one)(model_files[idx], mesh_directories[idx], dataset_directories[idx],
...
if __name__ == '__main__':
    ...
    generate_meshes(input_mesh_dir, output_data_dir, mesh_format, max_threads=max_threads, filter_lst=filter_lst, interval=interval) 