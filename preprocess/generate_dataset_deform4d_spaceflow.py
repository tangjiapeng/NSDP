...
def generate_flow(mesh_directory, dataset_directory, mesh_format, temp_lst, skip_existing=True, max_threads=-1, interval=1, pointcloud_size=200000, sigma1=0.1,sigma2=0.02):
    ...
    for f in template_modnames:
        ...
        # sample surface point clouds and then add noise along the normal direction
